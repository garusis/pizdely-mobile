...
$(window).load(function () {
	...
	function saveWhatsapp(){
		var  number = document.getElementById("whatsapp").value;

		$.ajax( { url: "https://api.mlab.com/api/1/databases/pizdely/collections/phones?apiKey=_C1tCJeoK4Fd_u8n5vZVqWNuhxzP1tep",
			data: JSON.stringify( { "number" : number } ),
			type: "POST",
			contentType: "application/json" } );

		document.getElementById("whatsapp").value = '';
		swal("¡Buena suerte! Que el poder de la pizza te acompañe");
	}

	document.getElementById("sendNumber").addEventListener("click",saveWhatsapp);
});
